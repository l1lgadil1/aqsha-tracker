...
import { TransactionAmount } from '../../types/transaction';
...
const AnimatedDigit: React.FC<{ digit: string; style: any }> = ({ digit, style }) => {
  ...
  return (
    <View style={styles.digitWrapper}>
      <Animated.Text style={[style, animatedStyle, styles.digit]}>
        {digit}
      </Animated.Text>
    </View>
  );
    ...
    >
      <View style={styles.amountContainer}>
        ...
        <View style={styles.digitContainer}>
          <Text style={[dynamicStyles.amount, styles.staticDigits]}>
            {wholeDigits.join('')}
          </Text>
          {/* <AnimatedDigit 
